            ...
            <div className="hidden md:flex space-x-4 items-center">
                ...
                {user ? (
                    <div className="flex items-center gap-3 ml-4 border-l pl-4 border-blue-400">
                        <div onClick={() => setCurrentPage("profile")} className="flex items-center gap-2 cursor-pointer hover:text-blue-200">
                            <User size={18} /><span className="font-bold">{user.username}</span>
                        </div>
